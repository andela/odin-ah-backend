 ...
 * */
class Notification { /* eslint-disable */
    ...
    async getNotification(req, res) {
        ...
        return res.status(200).json({ status: 'success', notifications, page, total });
    }
    ...
    async updateNotification(req, res) {
        ...
        res.status(200).json({ status: 'success', message: 'notification have been updated' });
    }
    ...
    async create(info) {
        ...
        this.io.emit(`notification-${userId}`, { message, type });
    }
